...
$sql ="SELECT `dept_id`, `emp_id`, `acct_id`, `payroll_id`, `emp_name`, `DOB`, `address`,
 `hire_date`, `designation` FROM `employees` where `emp_id`='$emp_id'";
...
<div class="display">
<table class="table" align="center" cellpadding="5px" border="1px solid blue" style="border-color: blue;">
  <tr>
  <th>DEPARTMENT ID</th>
  <th>EMPLOYEE ID</th>
  <th>ACCOUNT ID</th>
