...
<html>
<head>
    <title>Pay Group Search Result</title>
...
<table  width="95%" class="table" align="center">
  ...
  <tr>
    <td class="img">
    <h1 style="text-align: center;color: blue;">PAY GROUPS(<a href="../admin/adminpanel.php" style="text-decoration: none;">BACK</a>)</h1>
    <?php
$pg_id  =$_POST['pg_id'];
$dbhost ='localhost';
$dbuser = 'root';
...
$sql ="SELECT `pg_id`, `pg_id`, `pg_name` FROM `paygroup` where `pg_id`='$pg_id'";
mysql_select_db('pms');
