<?php
  ...
  $designation=$_POST['designation'];
   ...
   $sql=" INSERT INTO `employees`(`dept_id`, `emp_id`, `acct_id`, `payroll_id`, `emp_name`,`DOB`, `address`, `hire_date`, `designation`)  VALUES ('$dept_id', '$emp_id', '$acct_id', '$payroll_id','$emp_name', '$DOB','$address', '$hire_date','$designation')";
